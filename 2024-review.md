...
대회 입상은 못했지만, 제출했던 작품중 [[Baking News]]라는 기획이 마음에 들어서 내 제품으로 만들었다. RSS 기반의 AI 뉴스 요약(뉴스레터 생성) 솔루션이다. [[RSS]]로 일간 뉴스를 읽어오면 [[LLM]]이 하나의 뉴스레터로 요약해준다. 별도의 라이브러리 없이 개발했다가, 추후 [[SolidJS]]로 마이그레이션 하였다. 
