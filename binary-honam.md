---
title: "비 내리는 호남선 (binary-honam.postica.app)"
...
29일부터 31일까지 프론트엔드를 만들었다. 요즘 내 최애 프레임워크인 [[Astro]]를 사용했다. 왜 [[Garden]]은 Astro를 버리고 [[Go]]로 재작성 했으면서 새 프로젝트는 Astro로 하냐고요? 이게.. 조금 성격이 다르다.. Garden에서는 Astro와 잘 맞지 않는 미스매치가 있기도 했었고.. 그리고 무엇보다 도파민을 최대로 뽑아내기 위해서는 재밌고 힙한 스택을 쓰면서 최대한 빨리 일을 끝내야 하는 법이다.
