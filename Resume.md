...
- Tech: **[Frontend](프론트엔드)**, **UI Design**, and [](NLP) beginner🚶
...
- **디미페이(at 디미페이 팀)** 2021.06 ~ 2022.07
  ...
  - 한국디지털미디어고등학교 교내매점 키오스크, 관리 대시보드, 간편결제 개발팀
...
- **DaramGPT: Knowledge Distillation으로 가벼운 GPT 만들기**
  ...
  2022.09 / 개인연구
  <https://tilnote.io/books/6480b090e92fe5ef635f54df>

- **Icyfist: In-context Few Shot Text Style Transfer Architecture with Combined LLMs**

  > 언어모델에서 몇 개의 문체 예시만으로 대상 문장에 문체를 전이하는 모델 구조를 제안합니다. Non parallel few shot으로 In-context Inference가 가능하기 때문에, 개개인의 문체를 모사하는 개인화된 온디바이스 자동응답기를 개발하거나, 혹은 페르소나 대화에서 문체를 유지하는데 사용할 수 있습니다. 모델 구현에는 사전학습된 한국어 BART와 GPT를 사용하였습니다.

  2022.09 / 개인연구
  <https://tilnote.io/pages/648b254e62bb1e331c155ec9>
...
- **Keyword-based Question Generation with BART**
  ...
  2022.06 / 개인연구
  <https://tilnote.io/pages/64a84bf8a6b9183bbfd0c044>

---

## Artworks

![](https://server.tilnote.io/images/pages/7908edf8-b4ee-4ab7-8cb0-b8d70d68d703.png)

![](https://server.tilnote.io/images/pages/330ee483-aff8-4cc1-a5c8-3873d01a5c2a.png)

![](https://server.tilnote.io/images/pages/e4f0550c-f30d-4438-a5d4-2f2a2e6671cf.png)
